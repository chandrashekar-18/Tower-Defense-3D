...
// No need to add MenuItem here since a package currently in use titled "Unity UI Extensions" has the
// uGUITools class.
// Removing the MenuItem removes the unnecessary warnings produced by Unity.
